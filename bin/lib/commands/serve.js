...
import { log, ok, warn, fail, printJson, isJson, isQuiet } from '../output.js';
...
export function resolveHost(options) {
  ...
  const env = process.env.OMPCHAMBER_HOST;
