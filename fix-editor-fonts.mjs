...
desktopCode = desktopCode.replace(/const \[zoomLevel, setZoomLevel\] = useState\(13\);/, 'const [zoomLevel, setZoomLevel] = useState(13);');
...
mobileCode = mobileCode.replace(/const \[fontSize, setFontSize\] = useState\(12\);/, 'const [fontSize, setFontSize] = useState(13);');
