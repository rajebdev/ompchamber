import { Ticket } from 'lucide-preact';
import type { KenariCoupon, KenariQuota, KenariQuotaWindow } from '@/shared/types';
import { formatDateTime, formatPercent, formatRp, usedPercent } from '@/client/components/settings/categories/usage-settings/format';
