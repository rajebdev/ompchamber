import { Bot, Coins } from 'lucide-preact';
import type { UsageReport } from '@/shared/types';
import { buildProviders, statusLabel, type UsageProviderId } from '@/client/components/settings/categories/usage-settings/providers';
