...
import { BookOpen, Briefcase, Camera, Code2, Database, FlaskConical, Folder, Gamepad2, Globe, Heart, Home, Leaf, Lightbulb, Music, Palette, Plus, Rocket, Server, Shield, Smartphone, Terminal } from 'lucide-preact';
