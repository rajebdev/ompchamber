...
+  );`,
  ...
  },
  {
    ...
    name: 'write',
    type: 'write',
    title: 'write — app/components/workspace/chat-timeline/tool-renderers/AskPanel.tsx',
    target: 'app/components/workspace/chat-timeline/tool-renderers/AskPanel.tsx',
    input: {
      path: 'app/components/workspace/chat-timeline/tool-renderers/AskPanel.tsx',
      content: "import { HelpCircle, CheckCircle2 } from 'lucide-react';\n\nexport function AskPanel({ tool }) { ... }",
    },
    diff: {
      file: 'app/components/workspace/chat-timeline/tool-renderers/AskPanel.tsx',
      added: 45,
      removed: 0,
      diffText: `@@ -0,0 +1,45 @@
...
+}`,
    ...
    output: 'Wrote 45 lines (1.6 KB) to app/components/workspace/chat-timeline/tool-renderers/AskPanel.tsx',
    status: 'success',
    duration: '112ms',
  },
  {
...
Checks: 2/2 successful
  ...
  },
  {
    ...
    output: `app/components/workspace/chat-timeline/tool-renderers/AskPanel.tsx
app/components/workspace/chat-timeline/tool-renderers/BashPanel.tsx
app/components/workspace/chat-timeline/tool-renderers/EditPanel.tsx
app/components/workspace/chat-timeline/tool-renderers/EvalPanel.tsx
app/components/workspace/chat-timeline/tool-renderers/HubPanel.tsx
app/components/workspace/chat-timeline/tool-renderers/ReadPanel.tsx
app/components/workspace/chat-timeline/tool-renderers/SearchPanel.tsx
app/components/workspace/chat-timeline/tool-renderers/TodoPanel.tsx`,
    status: 'success',
    duration: '22ms',
  },
  {
