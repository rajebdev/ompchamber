...
import { UserBrowserAddressBar } from '@/components/workspace/user-browser-panel/AddressBar';
import { UserBrowserFrame } from '@/components/workspace/user-browser-panel/Frame';
import { useUserBrowser } from '@/hooks/browser/use-user-browser';
