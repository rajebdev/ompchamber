...
export const CommandDetailPane: React.FC<CommandDetailPaneProps> = ({
  command,
  isNew = false,
  onSave,
  onDelete,
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-40">
            ...
            <select
              ...
              onChange={(e) =>
                setFormData({ ...formData, scope: e.target.value as CommandScope })
              }
              disabled={formData.isBuiltIn}
          ...
          <div>
            ...
            <div className="flex items-center border border-ink/20 hover:border-ink/40 focus-within:border-ink rounded-lg bg-paper transition-colors">
              ...
              <select
                ...
                onChange={(e) => setFormData({ ...formData, overrideAgent: e.target.value })}
