...
import { ProjectDetailsHeader } from '@/components/settings/categories/project-settings/DetailsHeader';
import { ProjectNameInput } from '@/components/settings/categories/project-settings/NameInput';
import { ProjectModelDropdown } from '@/components/settings/categories/project-settings/ModelDropdown';
import { ProjectAccentPalette } from '@/components/settings/categories/project-settings/AccentPalette';
import { ProjectIconGrid } from '@/components/settings/categories/project-settings/IconGrid';
