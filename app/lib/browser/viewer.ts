...
import type { BrowserTabInfo, BrowserViewFrame, BrowserViewState } from '@/types';
import { shortUrl, type BrowserActionDraft } from '@/lib/browser/activity';
import { CdpConnection } from '@/lib/browser/cdp';
import { acquireConnection, releaseConnection } from '@/lib/browser/connection';
import { installObserver, OBSERVER_BINDING, parseObserverPayload, type ObserverHandle } from '@/lib/browser/observer';
import { parsePageTargets, pickTargetId, readTargetInfoPatch, type PageTarget } from '@/lib/browser/targets';
import { isRecord, readNumber, readString } from '@/lib/browser/util';
