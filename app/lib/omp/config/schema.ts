...
import schemaJson from '@/data/settings/omp-schema.json';
import type { OmpSchema, SchemaEntry } from '@/lib/omp/config/schema-types';
import type { ConfigEntry } from '@/lib/omp/config/config-cli';
import { SCHEMA_EXTRAS } from '@/lib/omp/config/schema-extras';
